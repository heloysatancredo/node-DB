...
let listCustomers = () => {
  let q =
    'SELECT firstName, middleInitial, lastName FROM customer WHERE active = true'
...
let listInactiveCustomers = () => {
  let q =
    'SELECT firstName, middleInitial, lastName FROM customer WHERE active = false'
...
let listActivePrimaryEmailAddresses = () => {
  let q =
    'SELECT firstName, lastName, emailAddr FROM customer, email WHERE customer.custID = email.custID AND email.active = true AND email.emailType = "primary"'
...
let listCompanyNames = () => {
  let q =
    'SELECT firstName, lastName, company FROM customer, email WHERE customer.custID = email.custID AND customer.active = true'
...
module.exports = {
  ...
  listActivePrimaryEmailAddresses,
  listCompanyNames,
  getSpecificCustomerEmailAddress,
  getCustomerByCustID,
}
